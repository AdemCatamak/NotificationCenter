...
namespace NotificationCenter.Controllers.WebMiddleware
{
    public class GeneralExceptionHandlerMiddleware
    {
        ...
        private async Task HandleException(Exception exception, ILogger logger, HttpContext context)
        {
            ...
            logger.Log(logLevel, eventId: default, typeof(GeneralExceptionHandlerMiddleware), exception, (type, ex) => $"TraceId: {traceIdentifier}{Environment.NewLine}{exception.Message}");
