...
namespace NotificationCenter.DataAccessLayer.IntegrationMessageBroker.MassTransitSection.MassTransitConverters
{
    public class MassTransitTypeNameHandlingConverter : JsonConverter
    {
